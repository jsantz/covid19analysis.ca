...
function play(delta) {
    ...
    if(!sample){
        ...
        if(timeline > 0){
            ...
            absperc[timeline]={t:timeline, y:perc(  mortalset[timeline].y
                    + immuneset[timeline].y
                    + infectedset[timeline].y
                    ,mortalset[timeline-1].y
                    + immuneset[timeline-1].y
                    + infectedset[timeline-1].y
                )};
...
var configperc = {
    ...
    options: {
        ...
        title: {
            display: true,
            text: 'Percent Population Changes'
        },
        tooltips: {
            mode: 'index',
        },
...
$('#runsimulation').click(function(){
    $("#graphholder").html("<h1>Resetting...</h1>");
    window.myLine.destroy();
    window.myLineP.destroy();
    ...
    $("#graphholder").html("<canvas id=\"canvasperc\"></canvas><canvas id=\"canvassim\"></canvas>");
