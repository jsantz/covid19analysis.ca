...
$("#runsimulation").click(function(){$("#graphholder").html("<h1>Resetting...</h1>");window.myLine.destroy();window.myLineP.destroy();bump=$("#isBounce").is(":checked");populations=$("#slider-range-min").slider("value");transmissibility=$("#transmissibility").slider("value");socialSpeed=$("#movementspd").slider("value")/100;quarantineLevel=$("#shelter").slider("value");Radius=$("#radius").slider("value");infectionLength=30*$("#infectionTime").slider("value");mortalityRate=$("#mortality").slider("value");
    naturalImmunity=$("#amountimm").slider("value");riskpop=$("#amountinf").slider("value");$("#graphholder").html('<canvas id="canvasperc"></canvas><canvas id="canvassim"></canvas>');app.destroy(!0);app=null;loader.reset();app=new Application({width:810,height:810,antialiasing:!0,transparent:!1,resolution:1});healthyset=[];immuneset=[];infectedset=[];mortalset=[];healthyperc=[];immuneperc=[];infectedperc=[];mortalperc=[];xvalsSim=[];timeline=0;var e={type:"line",data:{labels:xvalsSim,datasets:[{label:"Victim",
        ...
        b=document.getElementById("canvassim").getContext("2d");window.myLine=new Chart(b,e);e=document.getElementById("canvasperc").getContext("2d");window.myLineP=new Chart(e,a);renderScene()});$(function(){var e=$("#custom-handle");$("#slider-range-min").slider({range:"min",value:200,min:50,max:800,step:50,create:function(){e.text($(this).slider("value"))},slide:function(a,b){$("#amount").val(b.value);e.text(b.value)}});$("#amount").val(+$("#slider-range-min").slider("value"))});
$(function(){var e=$("#transmissibility-handle");$("#transmissibility").slider({range:"min",value:70,min:5,max:100,step:5,create:function(){e.text($(this).slider("value"))},slide:function(a,b){$("#transmissibility-label").val("% "+b.value);e.text("%"+b.value)}});$("#transmissibility-label").val("% "+$("#transmissibility").slider("value"))});
$(function(){var e=$("#movementspd-handle");$("#movementspd").slider({range:"min",value:100,min:10,max:200,step:10,create:function(){e.text($(this).slider("value"))},slide:function(a,b){$("#movementspd-label").val("% "+b.value);e.text("%"+b.value)}});$("#movementspd-label").val("% "+$("#movementspd").slider("value"))});
$(function(){var e=$("#shelter-handle");$("#shelter").slider({range:"min",value:0,min:0,max:100,step:5,create:function(){e.text($(this).slider("value"))},slide:function(a,b){$("#shelter-label").val("% "+b.value);e.text("%"+b.value)}});$("#shelter-label").val("% "+$("#shelter").slider("value"))});
$(function(){var e=$("#radius-handle");$("#radius").slider({range:"min",value:10,min:2,max:20,step:2,create:function(){e.text($(this).slider("value"))},slide:function(a,b){$("#radius-label").val(b.value);e.text(b.value)}});$("#radius-label").val($("#radius").slider("value"))});
$(function(){var e=$("#infectionTime-handle");$("#infectionTime").slider({range:"min",value:10,min:5,max:30,step:5,create:function(){e.text($(this).slider("value"))},slide:function(a,b){$("#infectionTime-label").val(b.value);e.text(b.value)}});$("#infectionTime-label").val($("#infectionTime").slider("value"))});
...
$(function(){var e=$("#amountimm-handle");$("#amountimm").slider({range:"min",value:1,min:0,max:400,step:20,create:function(){e.text($(this).slider("value"))},slide:function(a,b){$("#amountimm-label").val(b.value);e.text(b.value)}});$("#amountimm-label").val($("#amountimm").slider("value"))});
